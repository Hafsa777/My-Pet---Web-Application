  ...
  <div class="container">
    ...
    <form action="petController" method="post" name="pet" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr><td><input id="fname" type="text" name="name"  required></td></tr>
            
            <tr><td><label>Breed :</label></td></tr>
            <tr><td><input id="fname" type="text"  name="breed"  required></td></tr>
            
            <tr><td><label> Type</label> </td></tr>
            <tr><td><select name="type" id="fname">
            ...
            <tr><td><input id="fname" type="text" name="age"  required></td></tr>
            
            <tr><td><label>Sex :</label></td></tr>
            <tr><td><input id="fname" type="text" name="sex" required></td></tr>
           
            <tr><td><label>Color:</label></td></tr>
            <tr><td><input id="fname" type="text"  name="color"  required></td></tr>
            
            <tr><td><label>Veterinarian:</label></td></tr>
            <tr><td><input id="fname" type="text"  name="veterinarian"  required></td></tr>
